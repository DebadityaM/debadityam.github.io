...
tags:
  - meta
description: A first proper post — who I am, why this site exists, and what I plan to write about.
---
## Introduction
...
So, this along with some of my personal grief at the time, I decided to take a gap year after my undergrad, to work on the family business, learn the ins and outs, and figure out not only how to improve the business, but also how to make it less taxing on me and my dad. And I did learn a lot — but more on that later. What became clear early on, though, was that we really needed a website, both to increase our visibility and to fix how we were running things behind the scenes. More on that here: 
...
![A color-coded spreadsheet tracking weekly orders by customer and pickup location, with a column for every dish, per-item quantities and prices, and running totals down the right side and along the bottom.](../../assets/images/order-spreadsheet.png)
